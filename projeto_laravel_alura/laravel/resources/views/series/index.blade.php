...
@section('conteudo')
    <section class="cardsection">
        <div class="card mx-2">
            <div class="card-body">
                <a href="{{ route('criar_serie') }}" class="btn btn-slategray mb-4" name="" id="" role="button">
                        ...
                        <tbody>
                            @foreach ($series as $serie)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form method="post"
                                            action="{{ route('listar_temporadas', ['id' => $serie->id]) }}">
                                            @csrf
                                            @method('get')
                                    ...
                                    <td class="align-middle">
                                        <form method="post" action="{{ route('atualizar_serie', ['id' => $serie->id]) }}">
                                            @csrf
                                    ...
                                    <td class="align-middle">
                                        <form method="post" action="{{ route('deletar_serie', ['id' => $serie->id]) }}"
