        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <!-- Botoes -->
                    <div class="form-row">
                        <form method="post" action="{{ route('atualizar_serie_post', ['id' => $data->id]) }}">
                            @csrf
                            @method('put')
                            <button name="atualizar" id="atualizar" class="col-md-1 btn btn-primary m-2"
                                type="submit">Atualizar</button>
                            <a href="{{ route('listar_series') }}" class="col-md-1 btn btn-dark m-2"
